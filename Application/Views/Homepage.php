...
<section class="header">
    <nav>
        <a href="<?php echo BASEURL.'/Homepage'?>">
            <p><img src=<?php echo BASEURL.'/public/assets/images/logo5.png' ?> alt="logo" align="middle">
    ...
    <div class="options">
        <div class="optionA">
            <p>
                <img src=<?php echo BASEURL.'/public/assets/images/Vector.svg' ?>  alt="Phone"><br>
        ...
        <div class="optionB">
            <p>
                <img src=<?php echo BASEURL.'/public/assets/images/calendar.svg' ?> alt="calender"><br>
    ...
    <div class="articleHome">
        <div class="doctorImage">
            <img src=<?php echo BASEURL.'/public/assets/images/homepageDoctor.jpg' ?> alt="homepageDoctor">
        </div>
...
F
F
                        <img src=<?php echo BASEURL.'/public/assets/images/logo5.png' ?> alt="">
