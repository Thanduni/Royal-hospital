...
<?php foreach ($rows as $row):?>
            <div class="room">
                <div class="room-content">
                    ...
                    <!-- <div class="room-availability">Availability: <?php print $row['room_availability'] ?></div>  -->
                    <div class="room-availability">Availability: <?php if($row['room_availability']==1){print 'Yes';} else{print 'No';} ?></div>
                </div>
                <div class="icon-box">
