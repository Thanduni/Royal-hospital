...
if (isset($_SESSION['mailaddress']) && $_SESSION['userRole'] == 'Admin') {
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo BASEURL . '/css/adminStorekeeperPage.css' ?>">
        <title>Admin dashboard - Storekeeper</title>
        <style>
            p.royal {
                font-size: 20px;
            }
...
<!--            </ul>-->
            ...
            <p>
                <button type="button" id="addButton" class="custom-btn" onclick="displayStorekeeperAddForm()">+Add storekeeper</button>
...
//                $query = "SELECT user.nic, storekeeper.storekeeperID, user.name, user.profile_image FROM storekeeper inner join user where storekeeper.nic=user.nic limit " . $startinglimit . ',' . $numberPages;
//                $result = $con->query($query);
                ?>
                <div class="wrapper">
                    <div class="table">
                        <div class="row headerT">
                            ...
                            <div class="cell">StorekeeperID</div>
                            <div class="cell">Storekeeper Name</div>
                        ...
                        for ($j = 0; $j < $rows; ++$j) {
                            ...
                            <div class="row">
                                ...
                                <div class="cell" data-title="StorekeeperID">
                                    <?php echo $row[1]; ?>
                                </div>
                                <div class="cell" data-title="Storekeeper Name">
                                    <?php echo $row[2]; ?>
                                </div>
                                ...
                                <div class="cell" style="100px" data-title="Options">
                                    <a href="<?php echo BASEURL . '/Admin/delEdiUser.php?op=deleteStorekeeper&id=' . $row[0] ?>">
...
//                            echo '<a href="adminStorekeeperPage.php?page='.$btn.'"><li class="page-number active">'.$btn.'</li></a>';
//                        }
//
//                        ?>
<!--                    </ul>-->
            ...
            <form method="post" onsubmit="return validateNurseReceptionistStorekeeperForm()" enctype="multipart/form-data" id="addForm" name="userForm">
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td colspan="2">
                            <button class="custom-btn" type="submit" id="submit" name="addStorekeeper">Apply</button>
