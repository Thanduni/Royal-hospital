...
if (isset($_SESSION['mailaddress']) && $_SESSION['userRole'] == 'Nurse') {
    ...
    <head>
        ...
        <title>Nurse update profile - Nurse</title>
        <style>
            p.royal {
                font-size: 20px;
            }
    ...
    <div class="user">
        ...
        <div class="userContents" id="center">
            ...
            <ul>
                ...
                <li class="logout"><a href="<?php echo BASEURL . '/Homepage/logout.php?logout& url = http://localhost:8080'.$_SERVER['REQUEST_URI'] ?>">Logout <img src="../images/logout.svg">                               src="../images/logout.jpg">
                    </a></li>
            </ul>
            <div class="arrow">
    ...
    <script src=<?php echo BASEURL . '/js/validateNurse.js' ?>></script>
    </body>
