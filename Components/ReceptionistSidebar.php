...
<div id="sidebarMenu">
    ...
    <ul class="sidebarMenuInner">
        ...
        <li onmouseover="changeImage('noticeboard.svg', 'noticeboard')" onmouseout="restoreImage('noticeboardDef.svg', 'noticeboard')"><a id="notice" href="<?php echo BASEURL.'/Receptionist/receptionistNoticeBoard.php'?>" target="_self"><img id="noticeboard" class="butbut icons"
