...
?>
    ...
    <body>
                ...
                <div class="userClass">
                    ...
                    <table class="table">
                        ...
                        ?>
                            ...
                            <td style="100px">
                                <button class="edit" id="<?php echo $row[0] ?>" onclick="displayUserUpdateForm(<?php echo $row[0] ?>);"><img src="<?php echo BASEURL . '/images/edit.svg' ?>" alt="Edit">
                                    Edit
                                </button>
        ...
        <div id="userForm">
            <div id="form">
                <form method="post" onsubmit="return validateForm()" enctype="multipart/form-data" id="addForm" name="userForm">
